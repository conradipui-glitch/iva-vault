---
type: project
description: "Пул iva-write молчит третий день подряд (21–23.09, 22.09 вечером — отказ всех моделей); тексты постов Ива пишет сама по нарративу."
tags: ["codex","antigravity","content-pipeline","iva-write","pool","models","subscriptions","pipeline","provenance","fallback","model-pool","ops"]
status: active
...
- 2026-09-24: 23.09.2026, вечер (22:12): пул iva-write снова не справился — все модели вернули отказ на трёх постах-мыслях; тексты написаны самой Ивой по правилам скилла. Третий день подряд пул молчит (21–23.09), резервный путь «пишет сама Ива» работает штатно.
